...
def paper_data_experiment(data_cfg_path):
    ...
    fit_cfg_path = "configs/fit/test_fit.yml"
    ...
    # complete config is under results/gru_results/<run_id>/complete_config.yml and model_path = gru_forward_model_YYYY-MM-DD_HH-MM-SS.pt
    complete_cfg_path = str(model_path).replace("gru_forward_model", "/complete_config").replace(".pt", ".yml")
